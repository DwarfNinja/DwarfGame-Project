...
func get_room_data():
	...
	var shape_openings = [opening_northwest_west, opening_northwest_north, 
	opening_north, opening_northeast_north, opening_northeast_east, 
	opening_east, opening_southeast_east, opening_southeast_south, opening_south, 
	opening_southwest_south, opening_southwest_west, opening_west]
	
	var viable_connections = [connect_northwest_west, connect_northwest_north, 
	connect_north, connect_northeast_north, connect_northeast_east, 
	connect_east, connect_southeast_east, connect_southeast_south, 
	connect_south, connect_southwest_south, connect_southwest_west, connect_west]
